...
EvalState.prototype.fresh =
    function ()
    {
      return new EvalState(this.node, this.benv, this.store, this.lkont, this.kont);
    }
...
KontState.prototype.fresh =
    function ()
    {
      return new KontState(this.value, this.store, this.lkont, this.kont);
    }
