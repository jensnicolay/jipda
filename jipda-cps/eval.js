...
jseval.evalLiteral =
  function (node, benva, store, kont, c)
  {
    ...
    return kont[0].apply(value, store, kont.slice(1), c);
  }
...
StatementListKont.prototype.apply =
  function (value, store, kont, c)
  {
    ...
    if (i === nodes.length)
    {
      return kont[0].apply(newLastValue, store, kont.slice(1), c);
    }
...
jseval.evalVariableDeclaration =
  function (node, benva, store, kont, c)
  {
    ...
    return c.e.evalVariableDeclarator(nodes[0], benva, store, kont.addFirst(frame), c);
  }
...
VariableDeclarationKont.prototype.toString =
  function ()
  {
    return "<vration " + this.node.tag + " " + this.i + " " + this.benva + ">";
  }
...
VariableDeclarationKont.prototype.apply =
  function (value, store, kont, c)
  {
    ...
    return c.e.evalVariableDeclarator(nodes[i], benva, store, kont.addFirst(frame), c);
  }
...
jseval.evalVariableDeclarator =
  ...
  { 
    ...
    return c.e.evalNode(init, benva, store, kont.addFirst(frame), c);
  }
...
VariableDeclaratorKont.prototype.toString =
  function ()
  {
    return "<vrator " + this.node.tag + " " + this.benva + ">";
  }
...
jseval.applyBinaryExpressionPrim =
  function (node, leftPrim, rightPrim, benva, store, kont, c)
  {
    ...
    return kont[0].apply(c.l.join(prim, []), store, kont.slice(1), c);
  }
...
jseval.evalAssignmentExpressionIdentifier =
  ...
  { 
    ...
    return c.e.evalNode(right, benva, store, kont.addFirst(frame), c);
  }
...
AssignIdentifierKont.prototype.toString =
  function ()
  {
    return "<asid " + this.node.tag + " " + this.benva + ">";
  }
...
AssignIdentifierKont.prototype.apply =
  function (value, store, kont, c)
  {
    ...
    return kont[0].apply(value, store, kont, c);
  }
