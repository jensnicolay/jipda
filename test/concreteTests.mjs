...
const arrayStr = "[0 === 0, 0 !== 0, 1 === 0, 1 !== 0]";
const expected = eval(arrayStr).join(",");
run(arrayStr + ".toString()", expected);
const arrayStr2 = "[3<4,3<=4,3>4,3>=4,3<3,3<=3,3>3,3>=3,4<3,4<=3,4>3,4>=3]";
const expected2 = eval(arrayStr2).join(",");
run(arrayStr2 + ".toString()", expected2);
...
const arrayStr3 = "[0 || 1, 1 || 0, 0 && 1, 1 && 0, true || false, false || true, true && false, false && true]";
const expected3 = eval(arrayStr3).join(",");
run(arrayStr3 + ".toString()", expected3);
...
run(read("resources/inheritance1.js"), "Sparkie,Border Collie,ruff, ruff,The dog Sparkie is a Border Collie,true");
