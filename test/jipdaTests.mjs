...
runSource("'kajshdlkjasdkasjdhkajshd.com?access_token=sshshshshsh'.split('access_token=').length",2);
//runSource("'kajshdlkjasdkasjdhkajshd.com?access_token=sshshshshsh'.split('access_token=')[1]","sshshshshsh"); //FIXME: does not pass
