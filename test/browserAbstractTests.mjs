...
import {assert, assertEquals, assertTrue} from '../common';
...
function run(html, expected)
{
  ...
  const jsContext = new JsContext(jsSemantics, new Explorer(), tagAlloc, aacKalloc, store0, kont0);
  ...
  // const outputFileName = ("browserAbstractTest") + ".dot";
