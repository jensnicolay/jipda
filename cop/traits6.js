...
var cop = (function() {
  var contexts, ensureObject, exports, findScriptHome, strategies, traits;
  ...
  Context.prototype.activate =
      function __ACTIVATE__() {
        if (++this.activationCount === 1) {
          //print("*** activate", this.name);
  ...
  function Adaptation(context, object, trait) {
  ...
  Adaptation.prototype.deploy =
      function() {
        ...
        return extend(this.object, Object.create({}, this.trait), this.context);
      }
  ...
  function extend(target, source, context)
  {
    for (var prop in source) {
      var sourceMethod = source[prop] ? source[prop].method : undefined;
      var targetMethod = target[prop] ? target[prop].method : undefined;
      target[prop] = source[prop];
      //print("extend", context, sourceMethod, "->", targetMethod, "prop", prop);
    }
    return target;
  }
  ...
  function traceableMethod(object, name, method) {
    var wrapper;
  ...
  function traceableTrait(trait, object) {
